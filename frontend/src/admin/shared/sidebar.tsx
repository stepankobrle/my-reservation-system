...
import { MdDashboard, MdFastfood, MdPeople, MdAttachMoney, MdMessage, MdSettings, MdPerson } from "react-icons/md";
...
export default function Sidebar() {
    ...
    // Hlavní odkazy
    const links = [
        { to: "/admin", label: "AdminDashboard", icon: <MdDashboard /> },
        { to: "/admin/products", label: "Products", icon: <MdFastfood /> },
        { to: "/admin/customers", label: "Customers", icon: <MdPeople /> },
        { to: "/admin/transactions", label: "Transactions", icon: <MdAttachMoney /> },
        { to: "/admin/messages", label: "Messages", icon: <MdMessage /> },
    ];
